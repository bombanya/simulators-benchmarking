...
#define TIMER_CNTPCT_LO 0
#define TIMER_CNTPCT_HI 1
#define TIMER_CNTFRQ 4
...
CORETIMETYPE barebones_clock() {
	return (timer[TIMER_CNTPCT_HI] & 0x3FFF) | (timer[TIMER_CNTPCT_LO] >> 14);
}
...
secs_ret time_in_secs(CORE_TICKS ticks) {
	secs_ret retval=((secs_ret)ticks) / (secs_ret)(timer[TIMER_CNTFRQ]) * (secs_ret)(1 << 14);
	return retval;
}
